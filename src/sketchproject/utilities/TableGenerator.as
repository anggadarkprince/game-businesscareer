package sketchproject.utilities
{
	...
	/**
	 * Create and arrage data into table.
	 *
	 * @author Angga
	 */
	public class TableGenerator
	{
		...
		/**
		 * Default constructor of TableGenerator.
		 *
		 * @param container parent sprite
		 * @param header data
		 * @param headerWidth data
		 * @param data content of cell
		 * @param dataWidth width of cell
		 * @param align each cell
		 */
		 ...
		 * @param align each cell
		 */
		public static function createTable2(container:Sprite, header:Array, headerWidth:Array, data:Array, dataWidth:Array, align:Array):void
		{
			var bar:Image;
			var text:TextField;
