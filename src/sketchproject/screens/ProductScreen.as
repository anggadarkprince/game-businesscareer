package sketchproject.screens
{
	...
	public class ProductScreen extends GameScreen
	{
		...
		/**
		 * Default constructor of ProductScreen.
		 *
		 * @param hud
		 */
		...
		/**
		 * Product sub menu of product screen, manage price and support items.
		 *
		 * @param event
		 */
		...
		/**
		 * Inventory sub menu of product screen, manage materials and assets.
		 */
		...
		/**
		 * Supplier sub menu of product screen, manage suppliers and assets.
		 */
		...
		/**
		 * Switch page between product and supplier, because the inventory is dialog.
		 *
		 * @param page
		 */
