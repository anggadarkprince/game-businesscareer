package sketchproject.screens
{
	...
	/**
	 * Employee screen manage shop employee and benefits or shop's research.
	 *
	 * @author Angga
	 */
	public class EmployeeScreen extends GameScreen
	{
		...
		/**
		 * Default constructor of EmployeeScreen.
		 *
		 * @param hud
		 */
		...
		/**
		 * Resume sub menu of employee screen, show candidates of employee.
		 *
		 * @param event
		 */
		...
		/**
		 * Employee sub menu, show list of player's employee.
		 */
		...
		/**
		 * Program sub menu of employee screen.
		 */
