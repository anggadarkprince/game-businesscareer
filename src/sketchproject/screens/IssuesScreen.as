package sketchproject.screens
{
	...
	/**
	 * Show information and issues in next simulation.
	 *
	 * @author Angga
	 */
	public class IssuesScreen extends GameScreen
	{
		...
		/**
		 * Default constructor of IssuesScreen.
		 */
		public function IssuesScreen()
		{
			...
			shopingStreet = new TextField(500, 70, "Vihicles are not permitted on Main Street in the Shopping Distric todah, as we create an outdor mail from 10am to 5pm. Music and entertainment will be provided at not change. have a great day!", Assets.getFont(Assets.FONT_SSREGULAR).fontName, 13, 0x333333);
		...
		/**
		 * Previous information of districts.
		 *
		 * @param event
		 */
		...
		/**
		 * Update information depends on district location.
		 */
		...
		/**
		 * Update information and issues such as weather, temprature, events and trends.
		 */
		public function updateNewsIssues():void
		{
			...
			{
				event.text = "Tidak ada event hari ini";
			}
			...
			var education:Number = 0;
			var art:Number = 0;
			var athletic:Number = 0;

			var decoration:Number = 0;
			var scent:Number = 0;
			var cleaness:Number = 0;
			...
			shopingStreet.text = "Trend ketertarikan konsumen dengan event rata - rata \n     Education : " + education.toFixed(2) + "  Art : " + art.toFixed(2) + "  Athletic : " + athletic.toFixed(2);
			shopingStreet.text = shopingStreet.text + "\nTrend ketertarikan konsumen dengan atribut toko rata - rata \n     Decoration : " + decoration.toFixed(2) + "  Cleaness : " + cleaness.toFixed(2) + ",  Scent : " + scent.toFixed(2) + "";
		}
	}
}
