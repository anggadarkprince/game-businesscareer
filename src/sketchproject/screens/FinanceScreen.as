package sketchproject.screens
{
	...
	public class FinanceScreen extends GameScreen
	{
		...
		// timer to take delay avoid "not enough resources / memories"
		private var myTimer:Timer = new Timer(800);

		/**
		 * Default constructor of FinanceScreen.
		 */
		public function FinanceScreen()
		{
			...
			contentMask = new Quad(570, 300, 0xF2F2F2);
			contentMask.x = -220;
			contentMask.y = -190;
		...
		/**
		 * Update report request step by step each 800ms.
		 *
		 * @param event
		 */
		...
		/**
		 * Set the first content if all reports are ready.
		 *
		 * @param event
		 */
		...
		/**
		 * Select report menu and scroll if exist.
		 *
		 * @param touch
		 */
