package sketchproject.screens
{
	...
	/**
	 * Show map and generate freeman only.
	 * 
	 * @author Angga
	 */
	public class MapScreen extends GameScreen
	{
		...
		/**
		 * Default constructor of MapScreen.
		 */
		...
		/**
		 * Set max and min dragged map limit by zoom level.
		 */
		...
		/**
		 * Event handler when player drag the map.
		 * 
		 * @param e touch event
		 */
