package sketchproject.core
{
	...
	public class Game extends Sprite
	{
		...
		/**
		 * Triggered when load XML data and load server data complete.
		 *
		...
		{
			RectangleUtil.fit(new Rectangle(0, 0, stage.stageWidth, stage.stageHeight), new Rectangle(0, 0, size.x, size.y), ScaleMode.SHOW_ALL, false, Starling.current.viewPort);
		...
		/**
		 * Maintain task keep 4 when start the game.
		 */
		public function setupTask():void
		{
			Data.tasks.shift();
			Data.tasks.shift();
