package sketchproject.core
{
	...
	/**
	 * Assets collection and initializator.
	 *
	 * @author Angga
	 */
	public class Assets
	{
		...
		/**
		 * Populate atlas and get sprite atlas in directory.
		 *
		 * @param name key of sprites texture
		 * @param map xml sprite name inside atlas
		 * @return TextureAtlas
		 */
		...
		/**
		 * Retrieve texture data by spritesheet name from bitmap image in asset folder.
		 *
		...
		/**
		 * Get font asset and populate it into directory.
		 *
		...
		/**
		 * Registering default bitmap font and initialize all sounds.
		 */
		...
		/**
		 * Setup game sound by 10 level volume.
		 */
		...
		/**
		 * Play BGM sound by title.
		 *
		 * @param type title of bgm
		 */
