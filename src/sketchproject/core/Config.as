...
{	
	public class Config
	{
		...
		/** businessadviser information **/
		public static var Adviser:Array = new Array();
		Adviser["advisor1"] = "Shaka Ringgo";
		Adviser["advisor2"] = "Fitri Aisyah";
		Adviser["advisor3"] = "Shangrila";
		...
		/** emotion information **/
		public static var emotion:Array = [
			[
				"emotion_satisfied",
				"Satisfied",
				"Fast Serve, good morale",
				20
			],
			[
				"emotion_happy",
				"Happy",
				"Fast Serve or good morale",
				20
			],
			[
				"emotion_squint",
				"Squint",
				"Average Serve, morale",
				20
			],
			[
				"emotion_frown",
