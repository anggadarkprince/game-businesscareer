package sketchproject.objects.panel
{
	...
	public class CustomerPanel extends Panel
	{
		...
		/**
		 * Default constructor of CustomerPanel.
		 */
		public function CustomerPanel()
		{
			super(Assets.getAtlas(Assets.CONTENT, Assets.CONTENT_XML).getTexture("icon_lightning"), Assets.getAtlas(Assets.CONTENT, Assets.CONTENT_XML).getTexture("title_customer"), "Earn customer active by analysis customer relationship and advertising ");
		...
		/**
		 * Build charts and another components.
		 */
