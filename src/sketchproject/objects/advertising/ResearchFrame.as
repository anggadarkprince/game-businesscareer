package sketchproject.objects.advertising
{
	...
	public class ResearchFrame extends Sprite
	{
		...
		public function ResearchFrame()
		{
			...
			costText = new TextField(200, 50, "Cost per day "+Data.researchCost.toString(), Assets.getFont(Assets.FONT_SSBOLD).fontName, 18, 0x333333);
		...
		private function onChanged(event:starling.events.Event):void{
			...
			costText.text = "Cost per day IDR "+ValueFormatter.format(Data.researchCost);
