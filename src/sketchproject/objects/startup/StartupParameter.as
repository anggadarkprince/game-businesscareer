	...
	public class StartupParameter extends Sprite
	{
		...
		{	
			if (touch.getTouch(sliderPopulation, TouchPhase.HOVER))
			{
				showTips.showTips();
				showTips.tipsDirection(Tooltips.TIPS_LEFT);
				showTips.info = "Population number in your world";
			}
			else if (touch.getTouch(sliderWheater, TouchPhase.HOVER))
			{
				showTips.showTips();
				showTips.tipsDirection(Tooltips.TIPS_LEFT);
				showTips.info = "Good or bad wheater chaos";
			}
			else if (touch.getTouch(sliderEvent, TouchPhase.HOVER))
			{
				showTips.showTips();
				showTips.tipsDirection(Tooltips.TIPS_LEFT);
				showTips.info = "How much event will be happen";
			}
			else if (touch.getTouch(sliderCompetitor, TouchPhase.HOVER))
			{
				showTips.showTips();
				showTips.tipsDirection(Tooltips.TIPS_LEFT);
				showTips.info = "Set competitive market";
			}
			...
			else if (touch.getTouch(sliderAddicted, TouchPhase.HOVER))
			{
				showTips.showTips();
				showTips.tipsDirection(Tooltips.TIPS_RIGHT);
				showTips.info = "Customer addicting product";
			}
			...
			else if (touch.getTouch(sliderEmotion, TouchPhase.HOVER))
			{
				showTips.showTips();
				showTips.tipsDirection(Tooltips.TIPS_RIGHT);
				showTips.info = "Chance from emotion reaction";
			}
			else{
				showTips.hideTips();
			}
