package sketchproject.objects.business
{
	...
	public class HomeFrame extends Sprite
	{
		...
		public function HomeFrame()
		{
			...
			label = new TextField(250, 50, "Cash", Assets.getFont(Assets.FONT_CORegular).fontName, 18, 0x333333);
			...
			label = new TextField(250, 50, "Sallary AVG / Month", Assets.getFont(Assets.FONT_SSREGULAR).fontName, 14, 0x333333);
			label.vAlign = VAlign.TOP;
			label.hAlign = HAlign.LEFT;
			label.x = -400;
			label.y = -150;
			...
			label = new TextField(250, 50, "Sallary AVG / Day", Assets.getFont(Assets.FONT_SSREGULAR).fontName, 14, 0x333333);
			label.vAlign = VAlign.TOP;
			label.hAlign = HAlign.LEFT;
			label.x = -400;
			label.y = -120;
			...
			label = new TextField(250, 50, "Stress Chart", Assets.getFont(Assets.FONT_CORegular).fontName, 18, 0x333333);
			label.vAlign = VAlign.TOP;
			label.hAlign = HAlign.LEFT;
			label.x = -400;
			label.y = -50;
			...
			stressBarBase = new Quad(30,80,0xeb4a42);
			stressBarBase.x = -390;
			stressBarBase.y = -10;
			...
			baseBar = new Quad(200,4,0x333333);
			baseBar.x = -350;
			baseBar.y = 80;
			addChild(baseBar);
			
			label = new TextField(250, 50, "Hours", Assets.getFont(Assets.FONT_CORegular).fontName, 18, 0x333333);
			label.vAlign = VAlign.TOP;
			label.hAlign = HAlign.LEFT;
			label.x = -100;
			label.y = -180;
			...
			workAverage.hAlign = HAlign.LEFT;
			workAverage.x = 85;
			workAverage.y = -150;
			addChild(workAverage);
			
			label = new TextField(250, 50, "Total hours worked", Assets.getFont(Assets.FONT_SSREGULAR).fontName, 14, 0x333333);
			label.vAlign = VAlign.TOP;
			label.hAlign = HAlign.LEFT;
			label.x = -100;
			label.y = -120;
			...
			workTotal.hAlign = HAlign.LEFT;
			workTotal.x = 85;
			workTotal.y = -120;
			addChild(workTotal);
			
			label = new TextField(250, 50, "Work Chart", Assets.getFont(Assets.FONT_CORegular).fontName, 18, 0x333333);
			label.vAlign = VAlign.TOP;
			label.hAlign = HAlign.LEFT;
			label.x = -100;
			label.y = -50;
			...
			baseBar = new Quad(30,80,0xe02c78);
			baseBar.x = -85;
			baseBar.y = -10;
			addChild(baseBar);
		...
		public function updateInfo():void{
			...
			workAverage.text = Data.workAvg.toString();
			workTotal.text = Data.workTotal.toString();
