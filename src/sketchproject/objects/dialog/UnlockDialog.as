package sketchproject.objects.dialog
{
	...
	public class UnlockDialog extends Sprite implements IDialog
	{
		...
		/**
		 * Default constructor of UnlockDialog.
		 * 
		 * @param textInfo
		 * @param achievementIcon
		 */
		...
		/**
		 * Get unlocked achievement icon.
		 * 
		 * @return 
		 */
		public function get unlockIcon():String
		{
			return this.dialogIcon.texture.base.toString();
		}

		/**
		 * Open / show unlock achievement dialog.
		 */
		...
		/**
		 * Confirm unlocked achievment and close dialog.
		 * 
		 * @param event
		 */
