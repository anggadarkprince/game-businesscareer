package sketchproject.objects.dialog
{
	...
	/**
	 * Base confirmation and information dialog.
	 * 
	 * @author Angga
	 */
	public class NativeDialog extends Sprite implements IDialog
	{
		...
		/**
		 * Default constructor of NativeDialog.
		 * 
		...
		/**
		 * Secondary button event handler / [NO] Button.
		 * 
		...
		/**
		 * Secondary button event handler / [YES]-[OK] Button.
		 * 
		 * @params event passing triggered event
		 * @return void
		 */
