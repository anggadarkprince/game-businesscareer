package sketchproject.objects.dialog
{
	...
	public class HelpDialog extends Sprite
	{
		...
		/**
		 * Default constructor of HelpDialog.
		 */
		...
		/**
		 * Update content position when scrolled.
		 * 
		 * @return void
		 */
		...
		/**
		 * Check if scrollbar is necessary, if content overlap the container 
		 * then show scollbar otherwise hide.
		 * 
		 * @return void
		 */
