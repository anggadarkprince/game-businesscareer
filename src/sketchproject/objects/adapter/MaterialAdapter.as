package sketchproject.objects.adapter
{
	...
	/**
	 * Handle single material item add bar and item remove control,
	 * show in inventory screen.
	 *
	 * @author Angga
	 */
	public class MaterialAdapter extends ItemAdapter
	{
		...
		/**
		 * Default constructor of MaterialAdapter.
		 *
		 * @param index record
		 * @param id record id
		 * @param itemId material id
		 * @param name of material
		 * @param itemExpired expired remaining
		 * @param itemQuantity current stock
		...
		override public function set expiredRemaining(expired:int):void
		{
			...
			this.expiredText.text = "Expired for " + itemExpired + " Days";
		}
