package sketchproject.objects.adapter
{
	...
	public class AchievementAdapter extends Sprite
	{
		...
		/**
		 * Default constructor of AchievmentAdapter.
		 * 
		 * @param textureIcon achievement icon
		 * @param textureTitle achievement title
		 * @param description achievement info
		 * @param earned number of unlocked
		 */
		...
		/**
		 * Set number of unlocked achievment.
		 * 
		 * @param earn
		 */
		...
		/**
		 * Get number of unlocked achievement.
		 * 
		 * @return
		 */
