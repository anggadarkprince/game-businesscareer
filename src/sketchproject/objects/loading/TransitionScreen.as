package sketchproject.objects.loading
{
	...
	public class TransitionScreen extends Sprite
	{
		...
		/**
		 * Default constructor of TransitionScreen.
		 *
		 * @param type transition type
		 * @param titleMessage title transition
		 * @param subMessage subtitle transition
		 */
		...
		/**
		 * Change information of transition.
		 * 
