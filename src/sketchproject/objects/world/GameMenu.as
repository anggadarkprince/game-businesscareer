package sketchproject.objects.world
{
	...
	public class GameMenu extends HeadUpDisplay
	{
		...
		public function GameMenu()
		{
			...
			buttonAvatar.addEventListener(Event.TRIGGERED, onTrigerredInfo);
			...
			buttonBooster.addEventListener(Event.TRIGGERED, onTrigerredPerformance);			
			...
			buttonAdvertising.addEventListener(Event.TRIGGERED, onTrigerredAdvert);
