package sketchproject.objects.world
{
	...
	public class HeadUpDisplay extends Sprite
	{
		...
		/**
		 * Set zoom scale of map.
		 *
		 * @param zoom multipler
		 */
		...
		/**
		 * Release resources and remove event signal from mobile cart.
		 */
		...
		/**
		 * Show task list on left side, top of zoom control.
		 *
		 * @param taskContainer
		 */
		...
		/**
		 * Dispatch profit / instalment panel.
		 *
		 * @param event
		 */
